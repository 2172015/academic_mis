...
<head>
	...
	<link rel="icon" href={{ asset('/dosen/assets/img/kaiadmin/favicon.ico')}} type="image/x-icon"/>

	<!-- Fonts and icons -->
	<script src={{ asset('/dosen/assets/js/plugin/webfont/webfont.min.js')}}></script>
	<script>
		WebFont.load({
	...
	<!-- CSS Files -->
	<link rel="stylesheet" href={{ asset('/dosen/assets/css/bootstrap.min.css') }}>
	<link rel="stylesheet" href={{ asset('/dosen/assets/css/plugins.min.css') }}>
	<link rel="stylesheet" href={{ asset('/dosen/assets/css/kaiadmin.min.css') }}>

	<!-- CSS Just for demo purpose, don't include it in your project -->
	<link rel="stylesheet" href={{ asset('/dosen/assets/css/demo.css')}}>
</head>
<body>
	<div class="wrapper">
		<!-- Sidebar -->
			...
			<div class="sidebar-logo">
				...
				<div class="logo-header" data-background-color="dark">
					...
					<a href="index.html" class="logo">
						<img src={{ asset('/dosen/assets/img/kaiadmin/logo_light.svg')}} alt="navbar brand" class="navbar-brand" height="20">
					</a>
